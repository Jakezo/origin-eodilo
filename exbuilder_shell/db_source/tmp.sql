...
--
-- Host: localhost    Database: boss_enha44
-- ------------------------------------------------------
...
--
-- Table structure for table `french_attends`
--

DROP TABLE IF EXISTS `french_attends`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `french_attends` (
  `att_no` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '일련번호',
  `att_rv` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '예약번호',
  `att_member` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '회원',
  `att_state` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'A' COMMENT '출석여부 A:출석 X:결석',
  `att_date` date NOT NULL DEFAULT '0000-00-00' COMMENT '이용일',
  `att_in` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '최초입실일시',
  `att_out` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '최종퇴실일시',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`att_no`)
...
DROP TABLE IF EXISTS `french_iots`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `french_iots` (
  ...
  `i_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '룸이름',
  `i_sex` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'M' COMMENT '파트너번호',
  `i_type` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'R' COMMENT '구분',
  `i_iot1` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'IOT1',
  `i_iot2` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'IOT2',
  `i_iot3` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'IOT3',
  `i_iot4` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'IOT4',
  `i_endwork` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`i_no`)
...
CREATE TABLE `french_lockers` (
  ...
  `l_iot1` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '디바이스번호',
  `l_iot2` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`l_no`)
...
--
-- Table structure for table `french_maps`
--

DROP TABLE IF EXISTS `french_maps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `french_maps` (
  `m_no` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '일련번호번호',
  `m_bg` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '배경이미지',
  `m_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '배치도이름',
  `m_width` int(10) unsigned NOT NULL DEFAULT 1000 COMMENT '가로크기',
  `m_height` int(10) unsigned NOT NULL DEFAULT 500 COMMENT '세로크기',
  `m_map` text COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '맵포지션정보',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`m_no`)
...
CREATE TABLE `french_product_orders` (
  ...
  `o_member_from` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '회원구분(M,L)',
  ...
  `o_remainder` int(11) NOT NULL DEFAULT 0,
  ...
  `o_coupon` int(11) NOT NULL DEFAULT 0,
  `o_coupon_discount` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `french_reserv_lockers`
--

DROP TABLE IF EXISTS `french_reserv_lockers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `french_reserv_lockers` (
  `rl_no` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '일련번호',
  `rl_partner` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '파트너번호',
  `rl_order` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '구매번호',
  `rl_rv` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '예약번호',
  `rl_locker` int(10) unsigned DEFAULT NULL COMMENT '사물함번호',
  `rl_state` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '상태',
  `rl_sdate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '시작일',
  `rl_edate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '종료일',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`rl_no`)
...
CREATE TABLE `french_reserv_seats` (
  ...
  `rv_member_from` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '회원구분(M,L)',
  ...
  `rv_user` int(10) unsigned NOT NULL DEFAULT 0,
  ...
  `rv_revenue` bigint(20) NOT NULL DEFAULT 0,
  `rv_commission` bigint(20) NOT NULL DEFAULT 0,
...
CREATE TABLE `french_seats` (
  ...
  `s_iot_ext` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `s_age` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'A' COMMENT '나이구분',
  `s_sex` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'A',
