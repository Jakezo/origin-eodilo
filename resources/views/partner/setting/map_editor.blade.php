                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div id="page">
                                        ...
                                        <div id="room_bg" bg="{{ $bg_url }}" style="background-size:cover;background-position: left;background-repeat:no-repeat;background-image:url({{ $bg_url }});width:1000px;height:600px;border:1px solid red;">
