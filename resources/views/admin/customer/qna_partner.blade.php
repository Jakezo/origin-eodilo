                                ...
                                <div class='row'>
                                    <div class="col-md-2 col-sm-6 col-xs-12 mt-1">
                                        <select class="single-select form-control-sm col-12" name="answer" id="answer">
                                            <option value="" <?php if( !isset($param['answer']) && $param['answer'] == "" ) {?> selected<?php }?>>전체</option>
                                            <option value="N" <?php if( isset($param['answer']) && $param['answer'] == "N" ) {?> selected<?php }?>>답변대기</option>
                                            <option value="Y" <?php if( isset($param['answer']) && $param['answer'] == "Y" ) {?> selected<?php }?>>답변완료</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2 col-sm-6 col-xs-12 mt-1">
                                        <select class="single-select form-control-sm col-12" name="fd" id="fd">
                                            <option value="" <?php if( !isset($param['fd']) && $param['fd'] == "" ) {?> selected<?php }?>>제목+내용+작성자</option>
                                            ...
                                            <option value="uname" <?php if( isset($param['fd']) && $param['fd'] == "uname" ) {?> selected<?php }?>>작성자</option>
                                        </select>
                                    </div>
