                                ...
                                <div class='row'>
                                    ...
                                    <div class="col-lg-1 col-md-2 col-sm-4 col-xs-12 mt-1">
                                        <select class="single-select form-control-sm col-12" name="kind" id="kind">
                                            ...
                                            <option value="P" @if( isset($param["kind"]) && $param["kind"] == 'P' ) selected @endif>앱푸쉬</option>
                                            <option value="M" @if( isset($param["kind"]) && $param["kind"] == 'M' ) selected @endif>문자</option>
                                            <option value="K" @if( isset($param["kind"]) && $param["kind"] == 'K' ) selected @endif>카카오</option>
                                        </select>
                                    </div>
