        ...
        <div class="col">
            ...
            <ul class="nav nav-tabs nav-primary navbar-sm" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" data-bs-toggle="tab" href="/member/user_info?id={{ $user['id'] }}" role="tab" aria-selected="true">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" href="#primarycustom" role="tab" aria-selected="false">
                        <div class="d-flex align-items-center">
                            <div class="tab-icon"><i class="bx bxs-microphone font-18 me-1"></i>
                            </div>
